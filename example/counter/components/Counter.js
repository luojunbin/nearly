...
import {connect, dispatch, dispatcher, registerStore} from 'grax-react';
import * as counterDispatchers from '../actions/counter';
...
registerStore('counter', counterDispatchers);
