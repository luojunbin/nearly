...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _graxReact = __webpack_require__(53);
	
	var _counter = __webpack_require__(95);
	
	var counterDispatchers = _interopRequireWildcard(_counter);
	...
	var incr = function incr() {
	  return (0, _graxReact.dispatch)('counter.add', 1);
	}; /**
	...
	var incrAsync = function incrAsync() {
	  return (0, _graxReact.dispatch)('counter.addAsync', 1);
	};
	var decrAsync = function decrAsync() {
	  return (0, _graxReact.dispatch)('counter.addAsync', -1);
	};
	
	(0, _graxReact.registerStore)('counter', counterDispatchers);
	...
	function Counter(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'well' },
	      props.store.counter.count
	    ),
	    _react2.default.createElement(
	      'button',
	      { className: 'btn btn-default', onClick: decr },
	      '-'
	    ),
	    _react2.default.createElement(
	      'button',
	      { className: 'btn btn-default', onClick: incr },
	      '+'
	    ),
	    _react2.default.createElement(
	      'button',
	      { className: 'btn btn-default', onClick: decrAsync },
	      'async -'
	    ),
	    _react2.default.createElement(
	      'button',
	      { className: 'btn btn-default', onClick: incrAsync },
	      'async +'
	    )
	  );
	}
	...
	exports.default = (0, _graxReact.connect)('counter', Counter);
...
/***/ (function(module, exports) {
	...
	function add(getState, step) {
	  return {
	    count: getState().count + step
	  };
	}
	
	function addAsync(getState, step) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.renderServerApp = renderServerApp;
	...
	var IS_BROWSER = new Function('\n  try {\n    return this === window;\n  } catch (e) {\n    return false;\n  }\n')(); /**
	                                                                                                                       * @file 应用入口
	                                                                                                                       */
	
	function ServerApp(props) {
	  return _react2.default.createElement(
	    _graxReact.ContextProvider,
	    { state: props.state },
	...
	function renderClientApp() {
	  (0, _reactDom.render)(_react2.default.createElement(_Counter2.default, null), document.getElementById('root'));
	}
	
	function renderServerApp() {
	  return new Promise(function (resolve) {
	    (0, _graxReact.prepare)(['counter']).then(function (data) {
	      resolve({ data: data, html: (0, _server.renderToString)(_react2.default.createElement(ServerApp, { state: data })) });
	    });
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactDOMServer = __webpack_require__(63);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';var m=__webpack_require__(93),n=__webpack_require__(90),p=__webpack_require__(52),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
